...
def main():
    ...
    # - token_type_ids for Gemma3 training
    def preprocess(ex):
        ...
        # Gemma3 requires token_type_ids during training in your Transformers version
        token_type_ids = full_tok.get("token_type_ids")
        if token_type_ids is None or len(token_type_ids) != len(input_ids):
    ...
    ckpt = get_last_checkpoint(args.out_dir)
